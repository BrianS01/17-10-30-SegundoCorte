...
public class Database
{
    ...
    public static synchronized java.sql.Connection getConexion()
    {
    ...
    public static synchronized void cerrarConexion(java.sql.Connection cn) 
    {
        try 
        {
            cn.close();
    ...
    public static synchronized void deshacerCambios(java.sql.Connection cn) {
        try
        {
            cn.rollback();
        }
