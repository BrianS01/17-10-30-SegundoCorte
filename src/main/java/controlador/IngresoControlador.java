...
public class ControladorIngreso extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombre = request.getParameter("field1");
        String pass = request.getParameter("field2");
        IngresoDAO usuarioDao = new IngresoDAO();
        Usuario usuario = usuarioDao.getUsuarioByNameAndPass(nombre, pass);
        ...
        RequestDispatcher view = request.getRequestDispatcher("/SquemaLista.jsp");
        view.forward(request, response);
        }
